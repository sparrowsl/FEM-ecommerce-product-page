	...
	return (
		<>
			<section class="w-full px-10">
				<h3 class="text-orange uppercase mb-2 font-semibold text-sm">Sneaker Company</h3>
				<h1 class="text-4xl text-black font-bold mb-5">Fall Limited Edition Sneakers</h1>
				...
				<h3 class="font-bold text-xl flex items-center gap-3">
					$125.00
					<span class="text-sm bg-pale_orange text-orange px-2 rounded-sm">50%</span>
				</h3>
				<p class="line-through text-grayish_blue font-bold text-sm mt-1">$250.00</p>
				...
				<div class="mt-8 flex items-center gap-5">
					<div class="flex items-center gap-5 bg-light_grayish_blue w-fit rounded-md">
						...
						<p>{amount()}</p>
						<button type="button" class="p-4 block" onClick={() => setAmount(amount() + 1)}>
